...
if !exists('g:pdv_cfg_Php_Version') | let g:pdv_cfg_Php_Version = "7" | endif
if !exists('g:pdv_cfg_File_Description') | let g:pdv_cfg_File_Description = "Short description for file" | endif
...
if !exists('g:pdv_cfg_autoEndFunction') | let g:pdv_cfg_autoEndFunction = 0 | endif

" Whether or not to automatically add the class end comment (1|0)
if !exists('g:pdv_cfg_autoEndClass') | let g:pdv_cfg_autoEndClass = 0 | endif
...
func! PhpDocClass()
    ...
    for item in getline(0, line("."))
      if (match(item, 'namespace') == 0)
        let namespace = substitute(item, 'namespace ', '', 'g')
      endif
    endfor
    ...
    if g:pdv_cfg_annotation_Package == 1 && exists('namespace')
        let l:namespaceTab = split(namespace, '\')
        exe l:txtBOL . g:pdv_cfg_Commentn . "@category  " . l:namespaceTab[0] . g:pdv_cfg_EOL
        exe l:txtBOL . g:pdv_cfg_Commentn . "@package   " . l:namespaceTab[1] . g:pdv_cfg_EOL
    endif
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_File_Description . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_CommentBlank . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . 'PHP version ' . g:pdv_cfg_Php_Version . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_CommentBlank . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_License . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_CommentBlank . g:pdv_cfg_EOL
    ...
    if g:pdv_cfg_annotation_Version == 1
        exe l:txtBOL . g:pdv_cfg_Commentn . "@version   SVN: $Id$" . g:pdv_cfg_EOL
    endif
    if g:pdv_cfg_annotation_Version == 1
        exe l:txtBOL . g:pdv_cfg_Commentn . "@link      " . g:pdv_cfg_Link . g:pdv_cfg_EOL
    endif
